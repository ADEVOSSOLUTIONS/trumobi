...
You can now run the app from Android Studio. To do this, click the play button (green triangle) in the toolbar of Android Studio. It will open in the Android eumulator, where you see:
